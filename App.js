...
const FLYING_ITEMS = [
  ...
  'Airplane', 'Helicopter', 'Drone', 'Kite', 'Bee', 'Wasp', 'Dragonfly',
  'Mosquito', 'Fly', 'Moth', 'Ladybug', 'Firefly', 'Rocket', 'Balloon',
  'Peacock', 'Toucan', 'Macaw', 'Cockatoo', 'Kingfisher', 'Albatross'
];

const NON_FLYING_ITEMS = [
  'Dog', 'Cat', 'Elephant', 'Lion', 'Tiger', 'Horse', 'Cow', 'Sheep',
  'Goat', 'Pig', 'Rabbit', 'Snake', 'Fish', 'Shark', 'Whale', 'Dolphin',
  'Turtle', 'Crocodile', 'Frog', 'Lizard', 'Penguin', 'Ostrich', 'Emu',
